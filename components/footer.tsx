      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              <HoneycombIcon className="w-10 h-10" />
              <div>
                <span className="font-serif text-2xl font-bold">
                  {t.brand.name}
                </span>
                <p
                  className={`text-xs text-accent-foreground/70 ${lang === "ta" ? "font-[var(--font-tamil)]" : ""}`}
                >
                  {t.brand.tagline}
                </p>
              </div>
            ...
            <p
              className={`text-accent-foreground/80 max-w-md leading-relaxed ${lang === "ta" ? "font-[var(--font-tamil)]" : ""}`}
            >
          ...
          <div>
            <h3
              className={`font-serif text-lg font-semibold mb-4 ${lang === "ta" ? "font-[var(--font-tamil)]" : ""}`}
            >
              {t.footer.quickLinks}
            </h3>
            <ul className="space-y-2">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className={`text-accent-foreground/80 hover:text-accent-foreground transition-colors ${lang === "ta" ? "font-[var(--font-tamil)]" : ""}`}
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-accent-foreground/80">
              <li className="flex items-start gap-2">
                ...
                <span className={lang === "ta" ? "font-[var(--font-tamil)]" : ""}>
        ...
        <div className="mt-12 pt-8 border-t border-accent-foreground/20">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p
              className={`text-accent-foreground/80 text-sm ${lang === "ta" ? "font-[var(--font-tamil)]" : ""}`}
            >
